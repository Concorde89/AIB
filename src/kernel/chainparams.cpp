...
public:
    CMainParams() {
        ...
        consensus.SegwitHeight = 999999999; // AIB: Disabled for initial launch
        ...
        // AIB: No seeds yet - will add seed.aib.autoincentive.online when ready
        // vSeeds.emplace_back("seed.aib.autoincentive.online.");
